...
user.afkReason = ''
        ...
        if (isgclink) return m.reply(`EH GAJADI, TERNYATA LINK GRUP INI`)
        if (isGroupAdmins) return m.reply(`GAJADI, TERNYATA KAMU ADMIN`)
        if (isCreator) return m.reply(`EH GAJADI, TERNYATA KAMU OWNER`)
...
break
            ...
            case 'infochat': case 'bugtbm1': {
                if (!m.quoted) m.reply('Reply Pesan')
                let msg = await m.getQuotedObj()
                if (!m.quoted.isBaileys) throw 'kalau blank gunain wa inmune kack'
                let teks = ''
                for (let i of msg.userReceipt) {
                    let read = i.readTimestamp
                    let unread = i.receiptTimestamp
...
#2 - COMO ADICIONAR .blockspam NO SEU BOT 😏👍🏻 TUTORIAL COMPLETO
2,6 rb x ditonton · 3 bulan yang lalu
...
🎮 Como Criar Jogo De Plataforma (Baixar Construct 2 E Primeiros Passos) - Tutorial Construct 2 #01
One Day Code•271 rb x ditonton


0.21

Seru kan isengin teman 🤣🤣🤣
MFAS ID•18 rb x ditonton


LIVE

PUSH TO TOP 1 GRANDMASTER - RANKED 😎👽 #FREEFIRELIVE #NONSTOPGAMINGLIVE #RAILIVE #AJJUBHAILIVE
CRP Gaming•204 sedang menonton
...
8.47
Kena kartu merah TIMNAS malah nyerang total PART 1 | Indonesia Vs UEA | AFC U-19 2018
dribble9 - timnas football•798 rb x ditonton


34.38
Saya membangun kapal pesiar saya sendiri dengan bahan-bahan dari tempat barang rongsokan Penuh 90
Thánh Chế - Mr Hồ•20 jt x ditonton

8.10
RAJANYA IKLAN KOCAK! Deretan Iklan Thailand Paling Lucu dan Sangat Ngeselin Bikin Orang Salah Kaprah
Daftar Populer•1,8 jt x ditonton

20.57
AWAL MULA KIAMAT ZOMBIE | ALUR CERITA THE WALKING DEAD SEASON 1 (EPISODE 1-2)
ContentFiilm•2,1 jt x ditonton
...
17.27
MINUM KENCING, MAKAN KECOA, DEPRESI & TIDAK ADA SEORANGPUN YANG TAU | #NGALOR FILM TRAPPED (2016)
AlbumFilm•1,8 jt x ditonton
...
1.20.53
20220604 POLBAN IoT 5G AI
Onno Center•20 rb x ditonton
...
Disematkan oleh Bruxinho Tutorial 😎
Bruxinho Tutorial 😎
3 bulan yang lalu (diedit)
Muda o "black" para sua base 
